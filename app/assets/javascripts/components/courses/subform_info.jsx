  ...
  render: function() {
    ...
    return (
      <div className="new-course-form">
        ...
        <input type="text" placeholder="Course Summary" id="course_summary" onChange={this.props.handleSummaryChange} className="new-course-form-summary" defaultValue={this.props.summary}></input>
