var SubformMessage = React.createClass({
  ...
  handleEmailSave: function() {
    ...
    this.handleWelcomeEmailChange(email);
  },
  render: function() {
    return (
      <div className="new-course-form">
        ...
        <br/>
        <textarea placeholder="Welcome to my course! I'm so glad to hav... (now you fill in the rest!)" id="course_description" className="new-course-form-description" id="welcome-email" onChange={this.handleChange}></textarea>
